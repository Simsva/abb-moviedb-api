...
An API for use by [[github:abbs0agaber/GenericMovieDB][our movie database website]]. Source code available at [[github:Simsva/abb-moviedb-api][GitHub]].

See [[github:Simsva/abb-moviedb-api/blob/master/nginx_example.conf][nginx_example.conf]] for information on running the API.
